...
{
    public partial class Stegano_in_pic : Form
    {
        private Bitmap bmp = null;
        private string extractedText = string.Empty;

        public Stegano_in_pic()
        {
            InitializeComponent();
        }
        ...
        private void hideButton_Click(object sender, EventArgs e)
        {
            ...
            bmp = Stegano_in_picHelper.embedText(text, bmp);
        ...
        private void extractButton_Click(object sender, EventArgs e)
        {
            ...
            string extractedText = Stegano_in_picHelper.extractText(bmp);
